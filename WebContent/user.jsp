...
<title>Movie Rental Management System | List of Users</title>
      ...
      <div id="header">
        ...
        <div class="row-2">
          <ul>
            ...
            <li><a href="user.jsp" class="active">List users</a></li>
            <li><a href="getMovies.jsp">List of all Movies</a></li>
            <li class="last"><a href="addmovie.jsp">Add a new Movie</a></li>
          </ul>
        </div>
      </div>
        ...
        <div class="box">
          <div class="border-right">
            <div class="border-left">
              <div class="inner">
                <h3>List <span>of</span> All <span>Users</span></h3>
				<div>
